...
export function Header() {
  ...
  const links = [
    [
      c.hasEcommerce ? 'Shop flowers' : 'Our flowers',
      c.hasEcommerce ? '/shop' : '/gallery',
    ],
    ['Our story', '/about'],
        ...
        <div className="header-actions">
          ...
          {c.hasEcommerce && (
            <Link
              className="bag"
              href="/cart"
              aria-label={`Shopping bag, ${items.reduce((n, i) => n + i.quantity, 0)} items`}
            >
              <ShoppingBag size={21} />
